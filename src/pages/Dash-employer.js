...
const jobsDB = [
  { title: "Software Developer", applications: 42, status: "Active", date: "June 29, 2025" },
  { title: "Video Editor", applications: 31, status: "Active", date: "April 19, 2025" },
  { title: "Data Analyst", applications: 15, status: "In Review", date: "May 14, 2025" },
];
          ...
          <table className="w-full text-left text-sm font-montserrat min-w-[600px]">
            ...
            <tbody>
              {jobsDB.map((job, index) => (
                <tr key={index} className="border-b last:border-0 hover:bg-gray-50 transition-all">
